...
/*
 * 04_ObjectDetectionsSender.h - PCANBasic Example: ObjectDetectionsSender
 *
...
private:
	...
	/// </summary>
	/// <returns>A TPCANStatus error code</returns>
	TPCANStatus WriteMessageFD(double time_stamp, std::vector<ObjectDetection>& detections);
